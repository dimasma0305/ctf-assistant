...
export const command: SubCommand = {
  data: new SlashCommandSubcommandBuilder()
    .setName("unregister")
    .setDescription("Unregister a channel from receiving CTF mabar notifications")
  ...
  async execute(interaction, _client) {
    ...
    try {
      ...
      await interaction.editReply({
        content: `✅ Successfully unregistered ${targetChannel} from CTF mabar notifications!\n\n` +
